 ...
 *
 * modified by scottw@finaoonline.com to deal with a problem with paypal express order status
 */
namespace AlbumEnvy\Core\Plugin\Sales;
...
class OrderRepositoryPlugin
{
    ...
    {
        /*
        if($salesOrder->getState() !== \Magento\Sales\Model\Order::STATE_NEW && $salesOrder->getState() !== \Magento\Sales\Model\Order::STATE_PROCESSING){
            return $salesOrder;
        }
        */
